...
├── README.md
└── soutien-academique/
    ├── SKILL.md                              ← Skill principal (chargé en contexte)
...
2. **SKILL.md** (chargé quand le skill se déclenche) — Le corps principal avec les 6 modules, les principes, les réponses types. ~550 lignes. Contient les règles et la logique, pas les détails exhaustifs.
...
|-------|-----------------|----------------|
| `soutien-academique` | Mémoire pro, mémoire recherche, rapport de stage, soutien scolaire, dissertation/commentaire, soutenance | Lycée → Master |
...
- [ ] Skill `parcoursup` — Aide à la rédaction Parcoursup avec contraintes de caractères
